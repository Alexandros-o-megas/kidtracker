    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/localizacoes/**").hasRole("MOTORISTA")
                        .requestMatchers("/api/admin/**").hasRole("ADMIN")
                        .requestMatchers("/api/viagens/motorista/**").hasRole("MOTORISTA")
                        .requestMatchers("/api/encarregado/**").hasRole("ENCARREGADO")
